...
export function Environment(name: string): BaseURL {
    return `https://${name}-stomp-performance-scheduler-hxdi.encr.app`
}
...
/**
 * Client is an API client for the stomp-performance-scheduler-hxdi Encore application.
 */
export class Client {
 ...
 */
import type { auth as auth_auth } from "~backend/auth/encore_auth";
 ...
 */
import {
    googleAuth as api_auth_auth_googleAuth,
...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        public async forgotPassword(params: RequestType<typeof api_auth_password_reset_forgotPassword>): Promise<ResponseType<typeof api_auth_password_reset_forgotPassword>> {
            ...
            const resp = await this.baseClient.callTypedAPI(`/auth/forgot-password`, {headers, method: "POST", body: JSON.stringify(body)})
         ...
         */
        public async googleAuth(params: RequestType<typeof api_auth_auth_googleAuth>): Promise<ResponseType<typeof api_auth_auth_googleAuth>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/google`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_auth_googleAuth>
        }
...
import {
    ...
    deleteTour as api_scheduler_tours_deleteTour,
    deleteTourWeek as api_scheduler_tours_deleteTourWeek,
    getTours as api_scheduler_tours_getTours
} from "~backend/scheduler/tours";
...
export namespace scheduler {
    ...
    export class ServiceClient {
         ...
         */
        public async autoGenerate(params: RequestType<typeof api_scheduler_auto_generate_autoGenerate>): Promise<ResponseType<typeof api_scheduler_auto_generate_autoGenerate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/schedules/auto-generate`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_scheduler_auto_generate_autoGenerate>
        }

        /**
         * Creates a new schedule.
         */
        public async create(params: RequestType<typeof api_scheduler_create_create>): Promise<ResponseType<typeof api_scheduler_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/schedules`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_scheduler_create_create>
        }
        ...
        public async createTourBulk(params: RequestType<typeof api_scheduler_tours_createTourBulk>): Promise<ResponseType<typeof api_scheduler_tours_createTourBulk>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/tours/bulk-create`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_scheduler_tours_createTourBulk>
        }
         ...
         */
        public async deleteTour(params: { id: string }): Promise<ResponseType<typeof api_scheduler_tours_deleteTour>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/tours/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_scheduler_tours_deleteTour>
        }

        /**
         * Deletes a specific week from a tour
         */
        public async deleteTourWeek(params: { tourId: string, weekId: string }): Promise<ResponseType<typeof api_scheduler_tours_deleteTourWeek>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/tours/${encodeURIComponent(params.tourId)}/weeks/${encodeURIComponent(params.weekId)}`, {method: "DELETE", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_scheduler_tours_deleteTourWeek>
        }

        /**
         * Retrieves a schedule by ID.
         */
        public async get(params: { id: string }): Promise<ResponseType<typeof api_scheduler_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/schedules/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_scheduler_get_get>
        }
         ...
         * Updates a schedule.
         */
        public async update(params: RequestType<typeof api_scheduler_update_update>): Promise<ResponseType<typeof api_scheduler_update_update>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
         ...
         */
        public async validate(params: RequestType<typeof api_scheduler_validate_validate>): Promise<ResponseType<typeof api_scheduler_validate_validate>> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "stomp-performance-scheduler-hxdi-Generated-TS-Client (Encore/v1.57.9)";
        }
